...
public class ResourceUtil {
	...
	static {
		final ApplicationContext context = ApplicationContextUtil.getContext();
		if(Objects.isNull(context)){
			System.out.println("ApplicationContextUtil 初始化失败");
		}
		cacheService = context.getBean(CacheServiceI.class);
	}
